...
// this method upload the file,data etc in cloudinary
const uplodeOnCloudinary = async (localFilePath) => {
  ...
  try {
    ...
    fs.unlinkSync(localFilePath)  //remove the locally saved temporary file as the upload operation on cloudinary
    return null;
